...
class sfp_botscout(SpiderFootPlugin):
    ...
    # Default options
    opts = {"api_key": ""}
    optdescs = {"api_key": "Botscout.com API key. Without this you will be limited to 50 look-ups per day."}
    results = None
    errorState = False
    ...
    def handleEvent(self, event):
        ...
        res = self.sf.fetchUrl(url + eventData, timeout=self.opts["_fetchtimeout"], useragent=self.opts["_useragent"])
