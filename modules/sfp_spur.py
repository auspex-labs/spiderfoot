...
class sfp_spur(SpiderFootPlugin):
    ...
    def producedEvents(self):
        return ["IP_ADDRESS", "MALICIOUS_IPADDR", "RAW_RIR_DATA", "GEO_INFO", "COMPANY_NAME", "MALICIOUS_AFFILIATE_IPADDR"]
    ...
    def queryIPAddress(self, ipAddr):
        ...
        res = self.sf.fetchUrl(
            "https://api.spur.us/v1/context/" + ipAddr, headers=headers, timeout=15, useragent=self.opts["_useragent"]
        )
