...
class sfp_venmo(SpiderFootPlugin):
    ...
    def query(self, qry):
        res = self.sf.fetchUrl(
            "https://api.venmo.com/v1/users/" + qry, timeout=self.opts["_fetchtimeout"], useragent=self.opts["_useragent"]
        )
    ...
    def handleEvent(self, event):
        ...
        if display_name:
            evt = SpiderFootEvent("RAW_RIR_DATA", "Possible full name: " + display_name, self.__name__, event)
