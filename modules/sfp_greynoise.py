...
class sfp_greynoise(SpiderFootPlugin):
    ...
    meta = {
        ...
        "dataSource": {
            ...
            "references": ["https://docs.greynoise.io/", "https://greynoise.io/start", "https://greynoise.io/faq"],
            "apiKeyInstructions": [
    ...
    def queryIP(self, qry):
        ...
        res = self.sf.fetchUrl(url, timeout=self.opts["_fetchtimeout"], useragent="SpiderFoot", headers=header)
