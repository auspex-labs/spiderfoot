...
class sfp_darksearch(SpiderFootPlugin):
    ...
    meta = {
        ...
        "dataSource": {
            ...
            "references": ["https://darksearch.io/apidoc", "https://darksearch.io/dorks"],
    ...
    def query(self, qry, page):
        params = {"query": '"' + qry.encode("raw_unicode_escape").decode("ascii", errors="replace") + '"', "page": str(page)}
        ...
        while page <= pages:
            ...
            for result in data:
                ...
                if self.opts["fetchlinks"]:
                    ...
                    evt = SpiderFootEvent("DARKNET_MENTION_CONTENT", "..." + data + "...", self.__name__, event)
                    self.notifyListeners(evt)
