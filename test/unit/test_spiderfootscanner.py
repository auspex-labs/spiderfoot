...
class TestSpiderFootScanner(unittest.TestCase):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    SpiderFootScanner(
                        invalid_type, scan_id, "spiderfoot.net", "IP_ADDRESS", module_list, self.default_options, start=False
                    )
    ...
    def test_init_argument_scanId_as_empty_string_should_raise_ValueError(self):
        ...
        with self.assertRaises(ValueError):
            SpiderFootScanner(
                "example scan name", scan_id, "spiderfoot.net", "IP_ADDRESS", module_list, self.default_options, start=False
            )
    ...
    def test_init_argument_targetValue_of_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    SpiderFootScanner(
                        "example scan name", scan_id, invalid_type, "IP_ADDRESS", module_list, self.default_options, start=False
                    )
    ...
    def test_init_argument_targetType_of_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    SpiderFootScanner(
                        "example scan name", scan_id, "spiderfoot.net", invalid_type, module_list, self.default_options, start=False
                    )
    ...
    def test_init_argument_targetType_as_empty_string_should_raise_ValueError(self):
        ...
        with self.assertRaises(ValueError):
            SpiderFootScanner(
                "example scan name", scan_id, "spiderfoot.net", target_type, module_list, self.default_options, start=False
            )
    ...
    def test_init_argument_globalOpts_of_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    SpiderFootScanner(
                        "example scan name", scan_id, "spiderfoot.net", "IP_ADDRESS", module_list, invalid_type, start=False
                    )
